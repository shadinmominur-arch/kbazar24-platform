  ...
  return (
    <>
      ...
      <nav
        ...
        className="fixed bottom-0 left-0 right-auto z-50 grid h-16 w-[100dvw] max-w-[100dvw] grid-cols-[repeat(5,minmax(0,1fr))] items-stretch border-t border-hairline bg-white shadow-[0_-8px_24px_rgba(17,17,17,0.08)] lg:hidden"
        style={{
