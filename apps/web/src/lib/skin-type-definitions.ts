...
export const SKIN_TYPE_DEFINITIONS: SkinTypeDefinition[] = [
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Is hyaluronic acid good for dry skin in Bangladesh?', a: 'Hyaluronic acid is excellent for dry skin and particularly effective in Bangladesh\'s humid environment, as it draws moisture from the air into the skin. Apply it to damp skin after toning and seal with moisturiser. The Ordinary Hyaluronic Acid 2% + B5 and COSRX Hyaluronic Acid Intensive Cream are popular at Kbazar.' },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Which brands are best for sensitive skin in Bangladesh?', a: 'CeraVe, La Roche-Posay, and Avène are the gold standard for sensitive skin — all fragrance-free, clinically tested, and available at Kbazar. From K-beauty, Some By Mi Miracle Calming Toner and Skin1004 Centella products are popular for sensitive and reactive skin types in Bangladesh.' },
